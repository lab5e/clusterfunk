...
var liffs = []string{
	...
	"Fremantle (vb.): To steal things not worth the bother of stealing. One steals cars, money and silver. Book matches, airline eye­patches an individual pots of Trust House Forte apricot jam are merely fremantled.",
	...
	"Frosses (pl.n.): The lecherous looks exchanged beween sixteen-year-­olds at a party given by someone's parents.",
